...
# To test the model on images with reflection
    ...
    test_path = ["/mnt/d/Research/perceptual-reflection-removal/real20_420/blended"] #["./test_images/real/"]
    # test_path = ["/mnt/d/Research/YTMT-Strategy/real20_420/blended"] #["./test_images/real/"]
    subtask="RealCar" # if you want to save different testset separately
